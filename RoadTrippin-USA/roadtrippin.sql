...
INSERT INTO trip (user_id, name, `date`, description, origin_city, origin_state, destination_city, destination_state)
	values 
	(1, "Portland, OR to Phoenix, AZ", "2015-04-04", "I had 48 hours to travel 1,647 miles to make it in time to celebrate my friend Josh's birthday in Omaha, NE. I left at 5:30am and began the most beautiful drive East along the Columbia River. I stopped at Multnomah Falls ...", "Portland", "OR", "Phoexix", "AZ"),
	(1, "Omaha, NE to Portland, OR", "2014-07-29", "My move to Oregon began on a Wednesday morning with my best friend Jill. Our first stop was to visit the infamous Corn Palace in Mitchell, SD, but unfortunately they had just taken all the kernels off the exterior and ...", "Omaha", "NE", "Portland", "OR"),
